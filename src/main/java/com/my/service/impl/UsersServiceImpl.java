...
public class UsersServiceImpl implements UsersService
{
    ...
    @Override
    public RiskManagement selRMByUId(RiskManagement riskManagement)
    {
        return usersMapper.selRMByUId(riskManagement);
    }

    @Override
    public int insRMByUId(RiskManagement riskManagement)
    {
        return usersMapper.insRMByUId(riskManagement);
    }

    @Override
    public int updRMWLByRmId(RiskManagement riskManagement)
    {
        return  usersMapper.updRMWLByRmId(riskManagement);
    }

    @Override
    public int updRMWJCyRmId(RiskManagement riskManagement)
    {
        return usersMapper.updRMWJCyRmId(riskManagement);
    }

    @Override
    public int updRMCityByRmId(RiskManagement riskManagement)
    {
        return usersMapper.updRMCityByRmId(riskManagement);
    }
